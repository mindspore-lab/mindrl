...
from mindspore_rl.algorithm.dueling_dqn import config
...
def train(episode=options.episode):
    ...
    dueling_dqn_session = DuelingDQNSession(options.env_yaml, options.algo_yaml)
    dueling_dqn_session.run(class_type=DQNTrainer, episode=episode)
