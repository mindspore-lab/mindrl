...
parser.add_argument(
    "--episode", type=int, default=400000, help="total episode numbers."
)
parser.add_argument(
    "--device_target",
    type=str,
...
parser.add_argument(
    "--env_yaml",
    type=str,
    default="../env_yaml/simple_spread.yaml",
...
def train(episode=options.episode):
    ...
    env_name = config.algorithm_config["collect_environment"]["type"].__name__
