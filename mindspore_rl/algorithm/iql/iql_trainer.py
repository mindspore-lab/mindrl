...
class IQLTrainer(Trainer):
    ...
    def __init__(self, msrl, params):
        super(IQLTrainer, self).__init__(msrl)
        ...
        self.total_train = Parameter(Tensor(0, mindspore.float32), requires_grad=False, name="total_train")
    ...
    def train_one_episode(self):
        ...
        while self.less(steps, self.n_steps_per_episode):
            ...
            if self.total_train > self.offline_train_steps:
            ...
            (critic_loss, actor_loss, value_loss), mean_std = self.msrl.agent_learn(experience)
            steps += 1
            self.total_train += 1
        return (critic_loss, actor_loss, value_loss, mean_std), self.zero, self.zero
    ...
    def trainable_variables(self):
        ...
        trainable_variables = {"policy": self.msrl.learner.policy,
                               ...
                               "value_model": self.msrl.learner.value_model}
