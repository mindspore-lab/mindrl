...
class IQLTrainer(Trainer):
    ...
    def __init__(self, msrl, params):
        ...
        self.total_train = Parameter(
            Tensor(0, mindspore.float32), requires_grad=False, name="total_train"
        )
    ...
    def train_one_episode(self):
        ...
        while self.less(steps, self.n_steps_per_episode):
            ...
            (critic_loss, actor_loss, value_loss), mean_std = self.msrl.agent_learn(
                experience
            )
            steps += 1
            self.total_train += 1
