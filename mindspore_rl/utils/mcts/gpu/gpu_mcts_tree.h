...
#ifndef MINDSPORE_RL_UTILS_MCTS_GPU_GPU_MCTS_TREE_H_
#define MINDSPORE_RL_UTILS_MCTS_GPU_GPU_MCTS_TREE_H_
...
class GPUMonteCarloTree : public MonteCarloTree {
 public:
  GPUMonteCarloTree(MonteCarloTreeNodePtr root, float max_utility, int64_t tree_handle, int state_size,
                    int total_num_player)
      : MonteCarloTree(root, max_utility, tree_handle, state_size, total_num_player) {}

  ~GPUMonteCarloTree() override = default;
...
MS_REG_TREE(GPUCommon, GPUMonteCarloTree);

#endif  // MINDSPORE_RL_UTILS_MCTS_GPU_GPU_MCTS_TREE_H_
